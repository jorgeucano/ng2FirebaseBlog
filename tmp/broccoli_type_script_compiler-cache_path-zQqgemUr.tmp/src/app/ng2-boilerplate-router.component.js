...
var Ng2BoilerplateRouterAppComponent = (function () {
    ...
    Ng2BoilerplateRouterAppComponent.prototype.changeUrl = function (link) {
        alert("link");
    ...
    Ng2BoilerplateRouterAppComponent = __decorate([
        core_1.Component({
            ...
            directives: [router_1.ROUTER_DIRECTIVES, toolbar_1.MdToolbar],
        ...
        router_1.Routes([
            ...
            { path: '/post/:id', component: _post_1.PostComponent }
        ]), 
